...
def run_test_problem1a():
    ...
    print_expected_result_of_test([20, 30], expected, test_results, format_string)
    actual = problem1a(20, 30)
    print_actual_result_of_test(expected, actual, test_results)

    # Test 1:
    expected = -1.969  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([40, 50], expected, test_results, format_string)
